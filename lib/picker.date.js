...
DatePicker.prototype.formats = (function() {
    ...
    return {
        ...
        bb: function( string, dateObject ) {

            // If there's a string, then the length is always 2.
            // Otherwise return the selected year by slicing out the first 2 digits.
            return string ? 2 : ( '' + ( dateObject.year + 543 ) ).slice( 2 )
        },
        bbbb: function( string, dateObject ) {
        ...
        toArray: function( formatString ) { return formatString.split( /(d{1,4}|m{1,4}|y{4}|yy|b{4}|bb|!.)/g ) },
...
DatePicker.prototype.nodes = function( isOpen ) {
                    ...
                    _.group({
                        ...
                        item: function( loopedYear ) {
                            return [
                                ...
                                _.trigger( calendar.formats.toString, calendar, [ settings.formatSelectYear, { year: loopedYear } ] ), 0,
    ...
    return _.node(
        'div',
        createMonthLabel() + createYearLabel() + createMonthNav() + createMonthNav( 1 ),
